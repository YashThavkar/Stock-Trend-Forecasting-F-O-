...
# installed.
TCL_PREFIX='D:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/yash/Personal_data/Project/F-O-Prediction-Stock-market/venv\Library\lib\tclstub86.lib'
